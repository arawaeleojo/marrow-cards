            ...
            <div className="w-full h-full max-w-[360px] md:max-w-[320px]">
                ...
                >
                    ...
                    <div className="relative w-full h-full rounded-[26px] border border-black/10 overflow-hidden flex flex-col justify-between px-5 py-10">
                        ...
                        {/* TOP */}
                        <div className="relative z-10 text-center text-[11px] tracking-[0.25em] uppercase text-black/70">
                            [{category}]
                        </div>

                        {/* QUESTION */}
                        <div className="relative z-10 flex-1 flex items-center justify-center text-center px-4">
                            <p className="font-serif text-[21px] leading-[1.7] tracking-[-0.01em] text-black/90">
                                {question}
                            </p>
                        </div>

                        {/* BOTTOM */}
                        <div className="relative z-10 text-center text-[11px] tracking-[0.35em] uppercase text-black/70">
                            MARROW
